...
const prefix   = "!";
const category = "551869731947151390";
const devs     = ["441584713799303183", "441584713799303183"];
let mtickets   = true;
let tchannels  = [];
let current    = 0;
...
hero.on('message',async message => {
    const emojis   = { yes: `${hero.guilds.find(r => r.id === '553294246124453898').emojis.find(e => e.name === 'Yes')}`, wrong: `${hero.guilds.find(r => r.id === '553294246124453898').emojis.find(e => e.name === 'Wrong')}` };
